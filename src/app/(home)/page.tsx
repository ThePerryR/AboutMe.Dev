      ...
      <div className="bg-black pl-10 pb-10">
        <div className='max-w-[1608px] mx-auto'>
          <div className='relative text-black flex space-x-[140px]'>
            <div className="flex flex-col items-start pt-6 max-w-[500px] lg:max-w-[680px]">
              ...
              <h1 className='font-mono text-white text-6xl mb-8'>
                Showcase Yourself,<br />Share Your Story
              </h1>
              <h2 className='text-lg text-white text-opacity-60 mb-12'>
                Create a dynamic developer profile that speaks to your skills, projects, and coding journey.
              </h2>

              <Link href="/api/auth/signin" className='text-white mb-28 text-lg uppercase flex items-center'>
              ...
              <h3 className='text-white font-mono text-xl mb-5 opacity-80'>Why Join aboutme.dev?</h3>
              <p className='text-white opacity-60 leading-loose'>
            ...
            <div className='w-[524px] shrink-0 relative'>
